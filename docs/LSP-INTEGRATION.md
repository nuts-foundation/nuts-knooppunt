...
|-----------------------------------------------------------------|---------|------------------------------------------------------|--------------------------------------------------------|----------------------------------------------------------------------------|
| `jwt-bearer` grant type (RFC 7523)                              | 10.9.3  | Supported                                            | **Gap**                                                | [nuts-node#4080](https://github.com/nuts-foundation/nuts-node/issues/4080), [nuts-node#3968](https://github.com/nuts-foundation/nuts-node/pull/3968) |
