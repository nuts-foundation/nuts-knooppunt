...
func TestComponent_params_in_body(t *testing.T) {
	...
	assert.Equal(t, "http://fhir.nl/fhir/NamingSystem/bsn|775645332", policyInput.Action.Properties.ConnectionData.FHIRRest.SearchParams["identifier"])
...
func TestComponent_parse_patient_id(t *testing.T) {
	...
	assert.Equal(t, "12345", policyInput.Action.Properties.ConnectionData.FHIRRest.PatientID)
	...
	policyInput, _ = NewPolicyInput(pdpRequest)
	assert.Equal(t, "56789", policyInput.Action.Properties.ConnectionData.FHIRRest.PatientID)
	...
	policyInput, _ = NewPolicyInput(pdpRequest)
	assert.Equal(t, "98765", policyInput.Action.Properties.ConnectionData.FHIRRest.PatientID)
}
...
func TestNewPolicyInput(t *testing.T) {
	t.Run("patient resource ID parsing", func(t *testing.T) {
		...
		t.Run("multiple patient parameters", func(t *testing.T) {
			...
			assert.Empty(t, policyInput.Action.Properties.ConnectionData.FHIRRest.PatientID)
		})
