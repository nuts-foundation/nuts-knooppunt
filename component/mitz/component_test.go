...
func TestCreateXACMLAuthzDecisionQuery(t *testing.T) {
...
func TestCreateXACMLAuthzDecisionQuery_Structure(t *testing.T) {
	req := XACMLRequest{
...
func TestCreateXACMLAuthzDecisionQuery_AttributeIDs(t *testing.T) {
	req := XACMLRequest{
...
func TestCreateXACMLAuthzDecisionQuery_DataTypes(t *testing.T) {
	req := XACMLRequest{
...
func TestCreateSignedXACMLAuthzDecisionQuery(t *testing.T) {
	...
	xml, err := CreateSignedXACMLAuthzDecisionQuery(req, signingConfig)
	require.NoError(t, err)
	require.NotEmpty(t, xml)
...
func TestCreateSignedXACMLAuthzDecisionQuery_WithoutConfig(t *testing.T) {
	req := XACMLRequest{
		PatientBSN:             "123456789",
		HealthcareFacilityType: "Z3",
		AuthorInstitutionID:    "00000001",
	...
	_, err := CreateSignedXACMLAuthzDecisionQuery(req, nil)
	require.Error(t, err)
