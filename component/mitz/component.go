...
// XACMLRequest represents the parameters needed to create an XACML authorization decision query
...
// CreateXACMLAuthzDecisionQuery generates an unsigned SOAP envelope containing an XACML authorization decision query
// based on the example.xml structure
func CreateXACMLAuthzDecisionQuery(req XACMLRequest) (string, error) {
	return createXACMLAuthzDecisionQuery(req, nil)
}

// CreateSignedXACMLAuthzDecisionQuery generates a signed SOAP envelope containing an XACML authorization decision query
func CreateSignedXACMLAuthzDecisionQuery(req XACMLRequest, signingConfig *SigningConfig) (string, error) {
	if signingConfig == nil {
		return "", fmt.Errorf("signing config is required for signed queries")
	}
	return createXACMLAuthzDecisionQuery(req, signingConfig)
}

// createXACMLAuthzDecisionQuery generates a SOAP envelope (optionally signed) containing an XACML authorization decision query
func createXACMLAuthzDecisionQuery(req XACMLRequest, signingConfig *SigningConfig) (string, error) {
